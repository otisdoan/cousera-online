                        ...
                        <div className="bg-[#f6faff] p-7">
                            <div className="bg-[#e2f0ff] p-7 rounded-lg">
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <Button className="font-bold text-white bg-[#49bbbd] rounded-[5px] px-[25px] py-[18px]" onClick={handleStart}>Start</Button>
                                </div>
                            </div>
                            <div className="bg-[#d4faef] p-5 rounded-lg mt-[100px]">
                                ...
                                <div className="flex items-center gap-x-2 mt-[50px]">
                                    <div className="w-4 h-1 bg-[#087051]"></div>
                                    <div className="w-4 h-1 bg-[#087051]"></div>
                                    <div className="w-4 h-1 bg-[#087051]"></div>
                                </div>
                            </div>
